...
let enchants = [
	...
	{name:"落下耐性",ename:"fall_resistance",btarget:15,lng:[[1,1],[2,2],[3,3],[4,5]]},
	...
	{name:"射撃ダメージ増加",ename:"increase_arrow_damage",btarget:32,lng:[[1,2],[2,3],[3,5]]},
	{name:"ダメージ軽減",ename:"decrease_damage",btarget:15,lng:[[1,1],[2,2],[3,3],[4,5]]},
	{name:"ダメージ増加",ename:"increase_damage",btarget:16,lng:[[1,2],[2,3],[3,5]]},
	{name:"棘の鎧",ename:"thorns",btarget:15,lng:[[1,1],[2,2],[3,3]]},
	{name:"耐久力",ename:"durability",btarget:262143,lng:[[1,1],[2,2],[3,3]]},
	{name:"飛び道具耐性",ename:"projectile_resistance",btarget:15,lng:[[1,1],[2,2],[3,3],[4,5]]},
	...
	{name:"高速装填",ename:"quick_charge",btarget:64,lng:[[1,2],[2,3],[3,5]]},
	{name:"水中呼吸",ename:"water_breathing",btarget:1,lng:[[1,2],[2,3],[3,5]]},
	...
	{name:"浮遊",ename:"levitation",btarget:16,lng:[[1,2],[2,3],[5,5]]},
	{name:"固定火力",ename:"constant",btarget:262143,lng:[[1,3],[2,5]]},
	{name:"連撃",ename:"continue_arrow",btarget:32,lng:[[1,2],[2,3],[3,5]]},
	...
	{name:"ブラックホール",ename:"blackhole",btarget:2,lng:[[1,2],[2,3],[3,5]]},
	{name:"利口",ename:"genius",btarget:1,lng:[[1,0],[2,1],[3,2],[4,3],[5,5]]},
	{name:"流出",ename:"drown",btarget:16,lng:[[1,2],[2,3],[3,5]]},
	{name:"学習",ename:"study",btarget:1,lng:[[1,0],[2,1],[3,2],[4,3],[5,5]]},
	{name:"透明",ename:"invisible",btarget:8,lng:[[1,1]]},
	{name:"消失",ename:"vanish",btarget:2,lng:[[1,3]]},
	{name:"節約",ename:"savings",btarget:1,lng:[[1,0],[2,1],[3,2],[4,3],[5,5]]},
	{name:"崩壊",ename:"collapse",btarget:16,lng:[[1,0],[2,1]]},
	{name:"再生体",ename:"recovery",btarget:2,lng:[[1,2],[2,3],[3,5]]},
	{name:"軽量化",ename:"light",btarget:4,lng:[[1,1],[2,2],[3,3],[4,5]]},
	{name:"保管空間",ename:"save_space",btarget:133120,lng:[[1,2]]},
	{name:"瓦割り",ename:"breaking",btarget:16,lng:[[1,3]]},
	{name:"水性",ename:"water_type",btarget:2,lng:[[1,1],[2,2],[3,3],[4,5]]},
	...
	{name:"銅鑼",ename:"gong",btarget:2,lng:[[1,5]]},
	...
	{name:"着付け",ename:"take_on",btarget:16,lng:[[1,4]]},
	...
	{name:"検閲",ename:"inspection",btarget:133120,lng:[[1,3]]},
	{name:"千里眼",ename:"clairvoyance",btarget:133120,lng:[[1,5]]},
	{name:"抹消",ename:"erasure",btarget:133120,lng:[[1,3]]},
	{name:"足すくい",ename:"foot_chop",btarget:133120,lng:[[1,5]]},
	{name:"息吹",ename:"breath",btarget:133120,lng:[[1,1],[2,2],[3,3]]},
	{name:"プレゼント",ename:"present",btarget:16,lng:[[1,4]]},
	{name:"炭鉱夫",ename:"miner",btarget:1,lng:[[1,1],[2,2],[3,3]]},
	{name:"鑑定士",ename:"appraiser",btarget:1,lng:[[1,5]]},
	{name:"こだわり",ename:"commitment",btarget:1,lng:[[1,1],[2,2],[3,3],[4,5]]},
	{name:"ラッキーパンチ",ename:"lucky_punch",btarget:8192,lng:[[1,3]]},
	{name:"降臨",ename:"advent",btarget:133120,lng:[[1,3]]},
	{name:"間一髪",ename:"close_call",btarget:4,lng:[[1,3]]}
];
